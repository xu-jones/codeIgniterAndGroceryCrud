<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	//You can choose 'ckeditor','tinymce','markitup','kindeditor'
	$config['grocery_crud_default_text_editor'] = 'kindeditor';
	//You can choose 'minimal','full','mini-texteditor'
	$config['grocery_crud_text_editor_type'] 	= 'texteditor';
